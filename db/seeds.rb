...
User.create(name: 'みちや2', email: 'nishino.michiya0509@gmail.com', password: 'michiya0509',
            password_confirmation: 'michiya0509')
...
Article.create(title: 'テンプレートテンプレートテンプレートColdFusionの関数でよく使うもの', body: 'test',
               tag_name: 'ColdFusion,coldfusion,コールドフィージョン,便利関数', category_id: 2, user_id: 1)
Article.create(title: 'テンプレートテンプレートColdFusionの関数でよく使うもの', body: 'test', tag_name: 'テスト,ruby,Rails,sql,ColdFusion',
